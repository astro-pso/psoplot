"""
AAS Publication Style Example
=============================

This example demonstrates how to use the AAS publication style
through the `aas_plot` wrapper.
...
ax.set_title("AAS Publication Style")
...
# > plt.savefig("aas_style_example.png", bbox_inches="tight")
